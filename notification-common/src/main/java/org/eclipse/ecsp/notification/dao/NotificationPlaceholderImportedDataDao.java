...
/**
 * NotificationPlaceholderImportedDataDao interface.
 */
public interface NotificationPlaceholderImportedDataDao
    extends IgniteBaseDAO<String, NotificationPlaceholderImportedData> {
}
