...
/**
 * CloneNotificationTemplateConfig class.
 */
@Entity(useDiscriminator = false)
public class CloneNotificationTemplateConfig {
     ...
     * Constructor.
     */
    public CloneNotificationTemplateConfig() {
    }
    ...
    public String toString() {
        return "CloneNotificationTemplateConfig{" + "notificationId='" + notificationId + '\''
            + ", apiPushConfig=" + apiPushConfig + ", emailConfig=" + emailConfig + ", smsConfig=" + smsConfig + '}';
    }
}