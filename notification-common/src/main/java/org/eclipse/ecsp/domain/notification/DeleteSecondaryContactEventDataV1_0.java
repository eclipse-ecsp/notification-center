...
/**
 * DeleteSecondaryContactEventDataV1_0 class.
 */
@SuppressWarnings("checkstyle:TypeName")
@EventMapping(id = EventID.DELETE_SECONDARY_CONTACT, version = Version.V1_0)
public class DeleteSecondaryContactEventDataV1_0 extends AbstractEventData {
    private static final long serialVersionUID = 1L;
    private SecondaryContact secondaryContact;

    /**
     * DeleteSecondaryContactEventDataV1_0 Constructor.
     *
     * @param secondaryContact SecondaryContact
     */
    public DeleteSecondaryContactEventDataV1_0(SecondaryContact secondaryContact) {
     ...
     * DeleteSecondaryContactEventDataV1_0 Constructor.
     */
    public DeleteSecondaryContactEventDataV1_0() {
    }
