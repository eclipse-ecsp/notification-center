...
/**
 * AmazonPinpointSmsChannelResponseTest class.
 */
public class AmazonPinpointSmsChannelResponseTest {
    AmazonPinpointSMSChannelResponse response = null;
    ...
    public void testResponse() {
        response = new AmazonPinpointSMSChannelResponse();
        Assert.assertNotNull(response);

        response = new AmazonPinpointSMSChannelResponse("userID", "pdID");
        ...
        Assert.assertEquals(AWS_PINPOINT_SMS_PROVIDER, response.getProvider());
        Assert.assertNotNull(response.getTemplate());
        Assert.assertNull(response.getAlertData());
        Assert.assertEquals(ChannelType.SMS.toString(), response.getChannelType().toString());
