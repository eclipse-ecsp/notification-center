...
/**
 * ChannelServiceProviderConfigTest class.
 */
public class ChannelServiceProviderConfigTest {

    ChannelServiceProviderConfig config = new ChannelServiceProviderConfig();

    @Test
    public void testChannelServiceProviderConfig() {
        config.setChannelType(ChannelType.EMAIL);
        config.setId("id");
        config.setNotificationId("notificationId");
        config.setRegion("emea");
        config.setServiceProvider("aws");
