...
/**
 * IvmNotifier abstract class.
 */
public abstract class IvmNotifier extends AbstractChannelNotifier {

    private static final String CHANNELTYPE = ChannelType.IVM.getChannelTypeName();
