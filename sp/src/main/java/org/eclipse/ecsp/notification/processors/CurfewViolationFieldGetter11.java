...
/**
 * CurfewViolationFieldGetter11 class.
 */
public class CurfewViolationFieldGetter11 implements NotificationIdGetter {
    ...
    public String getNotificationId(AlertsInfo alert) {
        ...
        return data.append(alert.getEventID())
            .append(NotificationUtils.UNDERSCORE).append(TIME)
            .toString();
