...
/**
 * GeoFenceFieldGetter10 class.
 */
public class GeoFenceFieldGetter10 implements NotificationIdGetter {
    private static final Logger LOGGER = LoggerFactory.getLogger(GeoFenceFieldGetter10.class);
