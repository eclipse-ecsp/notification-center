...
@TestPropertySource("/UserProfileEnricher-integration-test.properties")
public class UserProfileEnricherIntegrationTest extends KafkaStreamsApplicationTestBase {
    private static final String[] PDID = {"HUR902N3KHU7U7", "HUXOIDDN4HUN19", "HUXOIDDN4HUN20", "HUXOIDDN4HUN21",
        "HUXOIDDN4HUN22"};
    private static final Logger LOGGER = LoggerFactory.getLogger(UserProfileEnricherIntegrationTest.class);
    ...
    private final String dffFeedBackTopic = "DffFeedBackTopic";
    ...
    public void setup() throws Exception {
        ...
        InputStream inputStream = UserProfileEnricherIntegrationTest.class
            .getResourceAsStream("/UserProfileEnricher-integration-test.properties");
        ...
        createTopics(notificationTopic, internalTopic, notificationSpDlqTopic, deviceStatusNotificationSpTopic,
            httpsIntegHigh, dffFeedBackTopic, schedulerSourceTopic);
    ...
    private void save() throws IOException {
        String notificationTemplateData = IOUtils.toString(
            UserProfileEnricherIntegrationTest.class.getResourceAsStream(
                "/userprofile-enricher-notification-template.json"),
            "UTF-8");

        String notificationTemp = IOUtils.toString(
            UserProfileEnricherIntegrationTest.class.getResourceAsStream(
                "/UserProfileEnricherNotificationTemplate.json"),
            "UTF-8");
        ...
        String notificationTemplateConfigData = IOUtils.toString(
            UserProfileEnricherIntegrationTest.class.getResourceAsStream(
                "/UserProfileEnricherNotificationTemplateConfig.json"),
            "UTF-8");
        ...
        String notificationGroupData = IOUtils.toString(
            UserProfileEnricherIntegrationTest.class.getResourceAsStream("/UserProfileEnricherNotificationGroup.json"),
            "UTF-8");
        ...
        String notificationConfigData = IOUtils.toString(
            UserProfileEnricherIntegrationTest.class.getResourceAsStream(
                "/UserProfileEnricher-notification-config.json"),
            "UTF-8");
        ...
        String userProfileData = IOUtils.toString(
            UserProfileEnricherIntegrationTest.class.getResourceAsStream("/user-profile-enricher.json"),
            "UTF-8");
    ...
    @Test
    @Ignore("testUpdateUserProfileDetails")
    public void testUpdateUserProfileDetails() throws Exception {
        ...
        String inputData =
            IOUtils.toString(UserProfileEnricherIntegrationTest.class.getResourceAsStream(
                    "/geoFence_in.json"), "UTF-8");
