 ...
 * @since 2.24
 */
public interface MuteVehicleService {
     ...
     */
    MuteVehicle createMuteConfig(MuteVehicleDto muteVehicleDto);
     ...
     * @return {@link MuteVehicle} model object
     */
    MuteVehicle getMuteConfigById(String vehicleId);
     ...
     */
    void deleteMuteConfigById(String vehicleId);
}
